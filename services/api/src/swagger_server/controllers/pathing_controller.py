...
def pathing_epe_bandwidth_get(dst_ip, min_bandwidth=None):  # noqa: E501
    ...
    :rtype: SRLabelStack
    """
    return pathing_controller.pathing_epe_bandwidth_get(dst_ip, min_bandwidth)
...
def pathing_epe_latency_get(src_ip, src_transport_ip, dst_ip, max_latency=None):  # noqa: E501
    ...
    :rtype: SRLabelStack
    """
    return pathing_controller.pathing_epe_latency_get(src_ip, src_transport_ip, dst_ip, max_latency)
...
def pathing_epe_lossless_get(dst_ip, max_loss=None):  # noqa: E501
    ...
    :rtype: SRLabelStack
    """
    return pathing_controller.pathing_epe_lossless_get(dst_ip, max_loss)
...
def pathing_epe_utilization_get(dst_ip, max_utilization=None):  # noqa: E501
    ...
    :rtype: SRLabelStack
    """
    return pathing_controller.pathing_epe_utilization_get(dst_ip, max_utilization)
