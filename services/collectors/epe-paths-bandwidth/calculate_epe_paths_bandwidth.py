import time
import epe_paths_generator, upsert_epe_paths_bandwidth as db_upserter
...
def upsert_link_utilization(egress_router, egress_router_interface, link_util_score, epe_path):
    ...
    epe_paths_bandwidth_key = "EPEPath:" + egress_router + "_" + egress_router_interface + "_" + destination    
    db_upserter.upsert_epe_path_bandwidth(epe_paths_bandwidth_key, egress_router, egress_router_interface, labels, destination, link_util_score)
