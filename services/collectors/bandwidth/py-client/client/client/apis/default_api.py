...
class DefaultApi(object):
    ...
    def get_collectors(self, field_name, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_collectors(field_name, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str field_name: (required)
        :param str weight_attribute:
        :param str router_src:
        :param str prefix_dst:
        :param str default_weight:
        :param str version:
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_collectors_with_http_info(field_name, **kwargs)
        else:
            (data) = self.get_collectors_with_http_info(field_name, **kwargs)
            return data

    def get_collectors_with_http_info(self, field_name, **kwargs):
        """
        get all collector services
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_collectors_with_http_info(field_name, callback=callback_function)
        ...
        all_params = ['field_name', 'weight_attribute', 'router_src', 'prefix_dst', 'default_weight', 'version']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('field_name' not in params) or (params['field_name'] is None):
            raise ValueError("Missing the required parameter `field_name` when calling `get_collectors`")
        ...
        query_params = {}
        if 'weight_attribute' in params:
            query_params['weight_attribute'] = params['weight_attribute']
        if 'router_src' in params:
            query_params['router_src'] = params['router_src']
        if 'prefix_dst' in params:
            query_params['prefix_dst'] = params['prefix_dst']
        if 'default_weight' in params:
            query_params['default_weight'] = params['default_weight']
