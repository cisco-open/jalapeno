#!/usr/bin/python
"""Deploy Paths Collector Service in OpenShift.
...
def main():
    """Load APIs and deploy Paths components using associated yaml files."""
    ...
    subprocess.call(["oc", "apply", "-f", "paths_collector_dp.yaml"])
