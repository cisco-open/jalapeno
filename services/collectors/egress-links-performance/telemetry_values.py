...
telemetry_value_mapper['subinterfaces__subinterface__state__counters__in-multicast-pkts'] = 'in-multicast-pkts'
telemetry_value_mapper['subinterfaces__subinterface__state__counters__out-multicast-pkts'] = 'out-multicast-pkts'

telemetry_value_mapper['subinterfaces__subinterface__state__counters__in-broadcast-pkts'] = 'in-broadcast-pkts'
telemetry_value_mapper['subinterfaces__subinterface__state__counters__out-broadcast-pkts'] = 'out-broadcast-pkts'

telemetry_value_mapper['subinterfaces__subinterface__state__counters__in-discards'] = 'in-discards'
telemetry_value_mapper['subinterfaces__subinterface__state__counters__out-discards'] = 'out-discards'
