...
def retrieve_device_info(host_ip, device_type):
...
def deploy_telemetry_config(device_type, hostname, host_ip):
...
def main():
    ...
    for host in hosts:
        ...
        hostname, loopback = retrieve_device_info(host_ip, device_type)
        if device_type == 'ios':
        ...
        deploy_telemetry_config(device_type, hostname, host_ip)
