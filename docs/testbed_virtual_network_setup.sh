...
echo adding iptables NAT entries so voltron k8s containers may be reached from the outside world
# openshift UI
...
# optional: NAT all outbound traffic from voltron/the server itself.  Uncomment if needed
