...
func (a *arangoDB) processigpv6LinkEdge(ctx context.Context, key string, l *message.LSLink) error {
	...
	rn, err := a.getv6Node(ctx, l, false)
	if err != nil {
	...
	if err := a.createv6EdgeObject(ctx, l, ln, rn); err != nil {
...
func (a *arangoDB) processv6LinkRemoval(ctx context.Context, key string, action string) error {
...
func (a *arangoDB) createv6EdgeObject(ctx context.Context, l *message.LSLink, ln, rn *message.LSNode) error {
	mtid := 0
	if l.MTID != nil {
