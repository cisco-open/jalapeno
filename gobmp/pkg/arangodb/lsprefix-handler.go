...
func (p *lsPrefixArangoMessage) MakeKey() string {
	...
	return strconv.Itoa(int(p.ProtocolID)) + "_" + strconv.Itoa(int(p.DomainID)) + "_" + strconv.Itoa(mtid) + "_" + p.AreaID + "_" + strconv.Itoa(int(p.OSPFRouteType)) + "_" + p.Prefix + "_" + strconv.Itoa(int(p.PrefixLen)) + "_" + p.IGPRouterID
}
